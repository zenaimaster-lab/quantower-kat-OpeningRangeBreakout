...
$src = "c:\Users\kieuanhtuan\Documents\all. Coding\mt5-kat-Strike"
$dst = "C:\Users\kieuanhtuan\AppData\Roaming\MetaQuotes\Terminal\D0E8209F77C8CF37AD8BF550E51FF075\MQL5\Experts\KAT Strike"
...
Start-Process -FilePath $compiler -ArgumentList "/compile:`"$dst\kat-Strike.mq5`" /log:`"$logFile`" /include:`"$mql5Root`"" -Wait -NoNewWindow
